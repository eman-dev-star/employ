                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="adress" type="adress" class="form-control @error('adress') is-invalid @enderror" name="adress" required autocomplete="new-adress">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date_of_birth" type="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" required autocomplete="new-date_of_birth">
